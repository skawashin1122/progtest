...
# --- ダミーの氏名リスト ---
DUMMY_NAMES = [
    "振徳 太郎", "鈴木 一郎", "高橋 花子", "田中 次郎", "伊藤 さくら", "渡辺 三郎", "山本 美咲", "中村 四郎", "小林 恵子", "加藤 五郎",
    "振徳 花子", "山田 六郎", "佐々木 陽菜", "山口 七郎", "松本 凛", "井上 八郎", "木村 結衣", "林 九郎", "斎藤 葵", "清水 十郎"
]
...
for i in range(NUM_STUDENTS):
    ...
    scores = {subject: random.randint(50, 100) for subject in SUBJECTS} # 各教科50点から100点のランダムな点数
